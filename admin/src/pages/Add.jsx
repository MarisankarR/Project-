...
const Add = ({token}) => {
  ...
  const [subCategory, setSubCategory] = useState("Towear");
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3 shadow-2xl shadow-purple-600 py-5 px-5 rounded-lg'>
      <div>
