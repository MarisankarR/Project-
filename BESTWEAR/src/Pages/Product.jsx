...
<div className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full '>
{
  ...
  <div className='w-full sm:w-[70%]'>
    <img className='w-[88%] h-[95%]' src={image} alt="" />
  </div>
</div>
{/* ---------------Product Info------------*/}
...
<p className='m-5 text-2xl font-medium'>{currency}{productData.price}</p>
...
<button onClick={()=>addToCart(productData._id,size)} className='bg-black text-white  pl-5 pr-5 pt-2 pb-2 text-sm active:bg-gray-700   rounded-xl'>ADD  TO  CART</button>
<NavLink to="/Cart"> <button  className='bg-black text-white  pl-5 pr-5 pt-2 pb-2 ml-3 text-sm active:bg-gray-700  rounded-xl '>GO TO CART</button></NavLink>
